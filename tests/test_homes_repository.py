...
def test_create_home(db_connection):
    ...
    assert homes == ["Home(1, test_title, test_location, test_description, 1, test_booked_dates", "Home(2, test_title2, test_description2, 2,)", "Home(3, test_title3, test_location3, test_description3, 3, test_booked_dates3)"]
